    ...
    <div class="col-sm-12">
        <table class="table table-responsive">
            ...
            @foreach(DB::table('site_stock')->select('stock_id', 'id', 'amount', 'entry_date', 'exit_date', 'site_detail')->where('site_id', '=', $site->id)->get() as $stock)
                ...
                $detail = !empty($stock->site_detail) ? $stock->site_detail : '';
                ...
                $id = $stock->id;
                $amount = $stock->amount;
                $stock = \App\Stock::withTrashed()->where('id', '=', $stock->stock_id)->first();
                        ...
                        @if($post_permission)
                            <td>
                                ...
                                <div class="row" style="display: none;">
                                    <div class="col-sm-6">
                                        <a href="#" class="text-danger btn-remove-sm" data-id="{{$id}}"><i
