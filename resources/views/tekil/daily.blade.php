...
$site_ended = false;
if (Carbon::parse($site->end_date) < Carbon::parse($report->created_at))
    $site_ended = true;
...
$can_edit_management_table = false;
$can_edit_employer_table = false;
$can_edit_subcontractors_table = false;
$can_edit_equipment_table = false;
$can_edit_work_table = false;
$can_edit_inmaterial_table = false;
$can_edit_outmaterial_table = false;
$can_edit_overtimes_table = false;
$can_edit_notes = false;
$can_edit_attachments = false;
$can_edit_view = false;

if ($user->isAdmin()) {
    $can_edit_management_table = true;
    $can_edit_employer_table = true;
    $can_edit_subcontractors_table = true;
    $can_edit_equipment_table = true;
    $can_edit_work_table = true;
    $can_edit_inmaterial_table = true;
    $can_edit_outmaterial_table = true;
    $can_edit_overtimes_table = true;
    $can_edit_notes = true;
    $can_edit_attachments = true;
    $can_edit_view = true;
} else {
    foreach ($user->group()->get() as $group) {
        if ($group->hasSpecialPermissionForSlug('yonetim-denetim-personel-tablosu')) {
            $can_edit_management_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('garden-yonetim-personel-tablosu')) {
            $can_edit_employer_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('alt-yukleniciler-personel-tablosu')) {
            $can_edit_subcontractors_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('ekipman-tablosu')) {
            $can_edit_equipment_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('yapilan-isler-tablosu')) {
            $can_edit_work_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('gelen-malzemeler-tablosu')) {
            $can_edit_inmaterial_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('giden-malzemeler-tablosu')) {
            $can_edit_outmaterial_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('puantaj-ve-yemek-tablosu')) {
            $can_edit_overtimes_table = true;
        }

        if ($group->hasSpecialPermissionForSlug('ertesi-gun-notlari')) {
            $can_edit_notes = true;
        }

        if ($group->hasSpecialPermissionForSlug('rapor-ekleri')) {
            $can_edit_attachments = true;
        }

        if ($group->hasSpecialPermissionForSlug('rapor-form-gorunumu')) {
            $can_edit_view = true;
        }
    }
}
...
var puantajApp = angular.module('dailyApp', [], function ($interpolateProvider) {
                    ...
                    $scope.addSwunit = function () {
                        ...
                        if ($scope.swSelected != '') {
                            ...
                            $scope.error = 'Alt yüklenici ekleyiniz!';
                        }
                    };
...
@section('content')
    ...
    <div ng-app="dailyApp">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-7">
                        ...
                        @if($can_edit_management_table)
                                        ...
                                        <div class="box-body">
                                            ...
                                            @if($report->management_staff > 0)
                                                <div class="row" id="div-management_staff">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <label for="main-staff-quantity[]"
                                                                   class="control-label">İdare
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group pull-right">
                                                        <a href="#"
                                                           class="btn btn-primary btn-flat add-main-staff-row">
                                                            Personel Ekle
                                                        </a>
                            ...
                            {{--End of Yönetim/Denetim--}}
                        @endif


                        @if($can_edit_employer_table)
                                                ...
                                                @if(sizeof($site_report_personnel)>0)
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3"><span
                                                                    style="font-style: italic">TCK No</span>
                                                        </div>
                                                        <div class="col-sm-5"><span
                                                                    style="font-style: italic">Ad Soyad</span>
                                                        </div>
                                                        <div class="col-sm-3"><span
                                                                    style="font-style: italic">İş Kolu</span>
                                                        </div>
                                                    </div>
                                                @endif
                                                @for($i = 0; $i < sizeof($site_report_personnel); $i++)
                                                    ...
                                                    <div class="row" id="div-staffid{{$report_person->id}}">
                                                        <div class="col-sm-1"><a href="#"><i
                                                                        ...
                                                                        data-personnel="{{$report_person->id}}"></i></a>
                                                        </div>
                                                        <div class="col-sm-3">
                                                <span>
                        ...
                        @if($can_edit_subcontractors_table)
                                        ...
                                        <div class="box-body">
                                            ...
                                            @if(sizeof($report_subcontractors)>0)
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3"><span
                                                                style="font-style: italic">Alt Yüklenici</span>
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group pull-right">
                                                        <a href="#"
                                                           class="btn btn-primary btn-flat add-equipment-row">
                                                            Ekipman Ekle
                                                        </a>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="box box-success box-solid">
                                ...
                                <div class="box-body" ng-controller="swController">
                                    ...
                                    <p class="text-danger alert-danger" ng-hide="!error"><%error%></p>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1">
                                                <input name="swQuantity" class="form-control" type="text"
                                                       ng-model="swQuantity"
                                                       placeholder="Kişi sayısı">
                                            </div>
                                            <div class="col-sm-1">
                                                <input class="form-control" type="text" ng-model="swUnit"
                                                       name="swunit"
                                            ...
                                            <div class="col-sm-1">
                                                <input type="text" class="number form-control" ng-model="swDone"
                                                       name="done"
                                                       placeholder="Yapılan">
                    ...
                    <div class="row" id="shifts_meals">
                        <div class="col-xs-12 col-md-12">
                            <div class="box box-success box-solid">
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <p>İlgili personeli puantaj tablosundan çıkarmak için yukarıdaki personel
                                        tablolarını
                                        kullanınız</p>
        ...
        @if($can_edit_attachments && !$site_ended)
                            ...
                            @if(!$locked)
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <p>Etiket eklemek veya düzenlemek için dosyaları yükledikten sonra
                                            sayfayı
                                            yenileyiniz.</p>
        ...
        @if (!isset($report_date) && $can_edit_view && !$site_ended)
            <div class="row hidden-print">
